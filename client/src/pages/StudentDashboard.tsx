        ...
        <div className="db-layout">
            ...
            <main className="db-main">
                ...
                >
                    ...
                    <div className="db-welcome-name">{user?.name || 'Student'}</div>
                    <div style={{ position: 'absolute', top: '24px', right: '24px', display: 'flex', gap: '12px' }}>
                        <MotionButton onClick={() => setIsJoinModalOpen(true)} variant="secondary">Join Group</MotionButton>
                        <MotionButton onClick={() => setIsGroupModalOpen(true)} variant="secondary">Start Group</MotionButton>
                        <MotionButton onClick={() => setIsModalOpen(true)}>+ New Order</MotionButton>
                    </div>
                </motion.div>
